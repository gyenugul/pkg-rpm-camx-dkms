# Contributing to pkg-rpm-camx-dkms
...
1. Create an upstream `remote` to make it easier to keep your branches up-to-date:
    ...
    ```bash
    git remote add upstream https://github.com/qualcomm-linux/pkg-rpm-camx-dkms.git
    ```
...
1. [Submit a pull request](https://github.com/qualcomm-linux/pkg-rpm-camx-dkms/pulls) from your branch to `main`.
